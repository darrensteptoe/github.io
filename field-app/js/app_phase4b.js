...
function wireEvents(){
  ...
  if (els.mcRun) els.mcRun.addEventListener("click", () => runMonteCarloNow());
    ...
    // Phase 4 — ROI inputs
    const ensureBudget = () => {
      if (!state.budget) state.budget = { overheadAmount: 0, includeOverhead: false, tactics: { doors:{enabled:true,cpa:0,crPct:null,srPct:null}, phones:{enabled:true,cpa:0,crPct:null,srPct:null}, texts:{enabled:false,cpa:0,crPct:null,srPct:null} } };
